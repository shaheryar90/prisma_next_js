...
import { ScrollTrigger } from "gsap/ScrollTrigger"; // Import ScrollTrigger for GSAP
    ...
    sections.forEach((section) => {
      ...
      gsap.from(text, {
        ...
        scrollTrigger: {
          ...
          scrub: 1,
          markers: true,
          // Add containerAnimation if needed, though it's not a standard ScrollTrigger property
        },
      });
    });
  }, []);
